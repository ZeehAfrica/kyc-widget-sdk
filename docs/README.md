...
| [Mobile & native apps](./mobile-integration.md) | Mobile web, WebView, deep links, camera requirements |
| [Hosting & CORS](./hosting-and-cors.md) | Deploying your app, HTTPS, API origins, environment config |
| [API client](./api-client.md) | `createZeehClient` for custom or headless integrations |
| [Troubleshooting](./troubleshooting.md) | Common issues (styling, CORS, camera, verification failures) |
...
For business onboarding (business ID, CORS allowlisting, sandbox access), contact your Zeeh account team or **support@zeeh.africa**.
