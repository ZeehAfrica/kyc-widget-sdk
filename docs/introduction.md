...
After `npm i @zeehdev/zeeh-kyc-react-sdk`:

| Export | Description |
|--------|-------------|
| `@zeehdev/zeeh-kyc-react-sdk` | Components, hooks, client factory |
| `@zeehdev/zeeh-kyc-react-sdk/style.css` | Pre-built Tailwind styles (required) |
